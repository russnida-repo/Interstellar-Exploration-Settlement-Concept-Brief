...
| **Teegarden’s Star b** | 12.6 | Promising but uncertain |
| **GJ 1002 b** | 15.8 | Ranked most likely habitable |
| **TRAPPIST-1e** | 40.7 | Well-studied; habitability uncertain |
...
- `docs/mission-brief.pdf` — **Primary reference document (PDF)**
